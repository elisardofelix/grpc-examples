...
const file_proto_streaming_proto_rawDesc = "" +
	...
	"\x04name\x18\x01 \x01(\tR\x04name2\xb3\x01\n" +
	"\x11FileUploadService\x12Q\n" +
	"\fDownloadFile\x12\x1e.streaming.DownloadFileRequest\x1a\x1f.streaming.DownloadFileResponse0\x01\x12K\n" +
	"\n" +
	"UploadFile\x12\x1c.streaming.UploadFileRequest\x1a\x1d.streaming.UploadFileResponse(\x01BLZJgithub.com/elisardofelix/grpc-examples/example-4-streamfile-tls-mtls/protob\x06proto3"
