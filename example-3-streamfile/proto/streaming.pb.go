...
const file_proto_streaming_proto_rawDesc = "" +
	...
	"\n" +
	"UploadFile\x12\x1c.streaming.UploadFileRequest\x1a\x1d.streaming.UploadFileResponse(\x01BCZAgithub.com/elisardofelix/grpc-examples/example-3-streamfile/protob\x06proto3"
