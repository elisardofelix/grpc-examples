...
type ConfigServiceClient interface {
	GetServerAddress(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetServerAddressResponse, error)
	LongRunning(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error)
	Flaky(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *configServiceClient) GetServerAddress(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetServerAddressResponse, error) {
...
func (c *configServiceClient) LongRunning(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *configServiceClient) Flaky(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
type ConfigServiceServer interface {
	GetServerAddress(context.Context, *emptypb.Empty) (*GetServerAddressResponse, error)
	LongRunning(context.Context, *emptypb.Empty) (*emptypb.Empty, error)
	Flaky(context.Context, *emptypb.Empty) (*emptypb.Empty, error)
...
func (UnimplementedConfigServiceServer) GetServerAddress(context.Context, *emptypb.Empty) (*GetServerAddressResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetServerAddress not implemented")
}
func (UnimplementedConfigServiceServer) LongRunning(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LongRunning not implemented")
}
func (UnimplementedConfigServiceServer) Flaky(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
...
func _ConfigService_GetServerAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConfigServiceServer).GetServerAddress(ctx, req.(*emptypb.Empty))
	}
...
func _ConfigService_LongRunning_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConfigServiceServer).LongRunning(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ConfigService_Flaky_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConfigServiceServer).Flaky(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
